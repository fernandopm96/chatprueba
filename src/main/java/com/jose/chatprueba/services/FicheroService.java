...
import com.jose.chatprueba.excepciones.StorageException;
import com.jose.chatprueba.excepciones.StorageFileNotFoundException;


/**
 * Implementación de un {@link IFicheroService} que almacena
...
public class FicheroService implements IFicheroService {
	...
	public FicheroService(@Value("${upload.root-location}") String path) {
